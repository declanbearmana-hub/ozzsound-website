...
const details={weddings:['Weddings','Music and atmosphere shaped around your day — from arrivals and formalities through to the dance floor.'],parties:['Birthdays & Parties','Milestones, private functions and celebrations with a soundtrack built around your crowd.'],schools:['School Functions','School discos, formals, graduations, presentations and celebrations with entertainment built around the students and the event.'],seasonal:['Seasonal Events','Halloween, Christmas, New Year and themed celebrations with music, sound and atmosphere tailored to the occasion.'],corporate:['Corporate Events','Clean, professional entertainment for staff functions, launches, awards nights and business events.'],sporting:['Sporting Events','Club nights, presentations, celebrations and sporting functions that need energy and reliable sound.'],karaoke:['Karaoke','Hosted karaoke for parties, venues, corporate events and private functions — built around the crowd and the night.'],other:['Your Event','If it needs music, sound and atmosphere, Ozzsound can tailor an entertainment setup around it.']};
